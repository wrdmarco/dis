...
Default behavior:
  Stops and disables DIS services, removes DIS systemd units, Nginx site config,
  PHP DIS ini files, generated Nginx config, and frontend production env.
  Application files, database, secrets and system user remain unless requested.
USAGE
}
