...
# Retained as an upgrade-compatibility source for update processes started by
# releases through d5ec230. Current installers remove the installed entrypoint.
