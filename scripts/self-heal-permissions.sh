...
for runtime_service in "${PHP_FPM_SERVICE}" dis-queue dis-media dis-scheduler dis-websocket dis-frontend dis-incident-enrichment dis-knmi dis-backup-request dis-osrm-admin-request; do
