...
import { currentLiveLocations, dispatchEtaLabel, isCurrentLiveLocation, liveLocationEtaLabel } from '../src/features/deployments/etaPresentation';
...
function liveLocation(overrides: Partial<DeploymentLiveLocation>): DeploymentLiveLocation {
  return {
    user_id: 'pilot-1',
    sharing_status: 'shared',
    location_is_current: true,
