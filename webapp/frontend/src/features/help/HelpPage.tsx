...
const helpTopics: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    group: 'operation',
    title: 'Weer',
    summary: 'Bekijk live DWD-radar, DMI-weerdata en EUMETSAT-bliksemdetectie zonder vliegadvies.',
    icon: CloudRain,
    href: '/weather',
    ...
    actions: [
      ...
      { title: 'Kaart bedienen', description: 'Zoek een locatie, sleep en zoom op de PDOK-kaart en centreer met de locatieknop.' },
      ...
      { title: 'Actualiteit controleren', description: 'De pagina controleert iedere vijf minuten op nieuwe data. Controleer altijd datastatus, bronnaam, geldigheid en eventuele beschikbaarheidsmelding.' },
    ],
  },
  {
    id: 'uav-forecast',
