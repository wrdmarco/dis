...
const helpTopics: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { title: 'Aantal mensen en ETA-ringen kiezen', description: 'Vul het gewenste aantal in. DIS zoekt eerst rond 15 minuten reistijd en vergroot daarna de ring per kwartier.', permissions: ['incidents.view', 'incidents.manage', 'incidents.dispatch.view'] },
  ...
  },
  {
    ...
    actions: [
      { title: 'Handmatig proefalarm sturen', description: 'Stuur een proefmelding naar je eigen actieve gekoppelde toestellen en volg direct of deze is ontvangen.' },
  ...
  },
  {
    ...
    group: 'management',
    title: 'Systeemstatus',
    summary: 'Bekijk de interne zelfcontrole en de belangrijkste ingestelde systeemonderdelen.',
    icon: Monitor,
    href: '/system',
