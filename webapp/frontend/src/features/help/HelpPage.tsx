...
const helpTopics: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    summary: 'Houd je contactgegevens, planning en operationele gegevens zelf bij.',
    icon: UserRound,
    href: '/profile',
    actions: [
  ...
  },
  {
    ...
    group: 'account',
    title: 'Agenda',
    summary: 'Bekijk gezamenlijke afspraken, capaciteit en jouw inschrijfstatus.',
    icon: CalendarDays,
    href: '/calendar',
    permissions: ['calendar.view'],
    actions: [
      { title: 'Afspraken bekijken', description: 'Bekijk afspraken voor jouw agendagroepen met datum, tijd, locatie, capaciteit en inschrijfstatus.' },
      { title: 'Jezelf inschrijven', description: 'Kies Ik kom zolang de inschrijving open is en er nog plaats is; afmelden kan vanuit dezelfde kaart.', permissions: ['calendar.view', 'calendar.register'] },
      { title: 'Afspraken beheren', description: 'Koppel één of meer agendagroepen, stel inschrijving en capaciteit in en pas afspraken aan.', permissions: ['calendar.view', 'calendar.manage'] },
      { title: 'Deelnemers beheren', description: 'Bekijk de deelnemerslijst en schrijf namens de organisatie een gebruiker in of uit.', permissions: ['calendar.view', 'calendar.registrations.view', 'calendar.registrations.manage'] },
      { title: 'Agendagroepen beheren', description: 'Combineer directe gebruikers met automatisch door teams overgeërfde leden. Iedereen is een beschermde systeemgroep.', permissions: ['calendar.view', 'calendar.groups.manage'] },
    ],
  },
  {
    id: 'product-requests',
  ...
  },
  {
    ...
    actions: [
      ...
      { title: 'Piloot handmatig koppelen', description: 'Zoek hoofdletterongevoelig en koppel tijdens een actieve, alarmerende of lopende inzet een extra piloot met een verplichte reden. Ook na Ik kom niet of Geen reactie kan dit; de piloot krijgt een informatief pushbericht, maar geen alarm.', permissions: ['deployments.dispatch.manage'], oneOfPermissions: ['deployments.view', 'deployments.manage'] },
      { title: 'Opkomststatus corrigeren', description: 'Zet een werkelijk aan deze inzet gekoppelde piloot inzetgebonden op Onderweg of Op locatie.', permissions: ['deployments.dispatch.manage', 'status.override'], anyPermission: true, oneOfPermissions: ['deployments.dispatch.view', 'deployments.dispatch.manage'] },
  ...
  },
  {
    ...
    actions: [
      ...
      { title: 'Weekrapport bekijken', description: 'Bekijk wie is geselecteerd, voor wie de pushdienst de melding accepteerde en wie de ontvangst in de operator-app bevestigde.' },
    ],
  },
  {
    id: 'map',
  ...
  },
  {
    ...
    group: 'operation',
    title: 'Weer',
    summary: 'Bekijk live buien en bliksem voor Nederland, België en westelijk Duitsland, zonder vliegadvies.',
    icon: CloudRain,
    href: '/weather',
  ...
  },
  {
    ...
    actions: [
      ...
      { title: 'Vakantieplanning bekijken', description: 'Bekijk de geplande periodes en de ingestelde beschikbaarheid van een gebruiker.', permissions: ['vacations.view'] },
      { title: 'Vakantieplanning beheren', description: 'Voeg periodes toe, pas datums, beschikbaarheid en notitie aan of verwijder een periode na een extra bevestiging.', permissions: ['vacations.manage'] },
  ...
  },
  {
    ...
    actions: [
      ...
      { title: 'Uitvraag per onderwerp', description: 'Plaats een veld onder Gemeenschappelijk, Mens, Dier of Object, kies waar nodig de adreszoeker en bepaal of het in de Operator-app zichtbaar is. De technische sleutel blijft stabiel.' },
      { title: 'Dubbele invoer voorkomen', description: 'Koppel alleen Opkomstlocatie aan de inzetlocatie. Laatst gezien locatie blijft een zelfstandig antwoord. Velden uit exclusieve Mens-, Dier- en Objecttakken mogen hetzelfde inzetdoel delen.' },
  ...
  },
  {
    ...
    actions: [
      ...
      { title: 'Store-review voorbereiden', description: 'Download per platform de actuele review-QR. Deze koppelt de reviewer direct, verloopt niet vóór gebruik en wordt na de eerste succesvolle koppeling automatisch vernieuwd. Een reviewsessie duurt maximaal 24 uur.', permissions: ['settings.manage'] },
  ...
  },
  {
    ...
    actions: [
      ...
      { title: 'Installeren of kaartdata bijwerken', description: 'Een beheerder met routeringsrecht kan de voorgestelde actie starten en de voortgang in het live log volgen.', permissions: ['system.routing.manage'] },
      { title: 'Automatische routecontrole', description: 'DIS test na verwerking zelf vaste Nederlandse en Belgische controlepunten. Er hoeft geen GPS-coördinaat te worden ingevoerd.' },
    ],
  },
  {
    id: 'system',
