...
const helpTopics: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { title: 'Store-review voorbereiden', description: 'Download per platform de vaste review-QR. Deze vult alleen de publieke DIS-server en reviewer-gebruikersnaam in; het afzonderlijke wachtwoord blijft nodig en een reviewsessie duurt maximaal 24 uur.', permissions: ['settings.manage'] },
