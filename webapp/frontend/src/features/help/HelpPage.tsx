...
const helpTopics: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { title: 'Piloot handmatig koppelen', description: 'Koppel tijdens een actieve, alarmerende of lopende inzet een extra piloot met een verplichte reden. De piloot krijgt een informatief pushbericht, maar geen alarm.', permissions: ['deployments.dispatch.manage'], oneOfPermissions: ['deployments.view', 'deployments.manage'] },
