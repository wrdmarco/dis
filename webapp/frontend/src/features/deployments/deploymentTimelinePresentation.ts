import type { DeploymentTimelineItem } from '../../types/api';

export interface DeploymentTimelinePresentation {
  action: string;
  actorLabel: string | null;
  detail: string | null;
}

export function presentDeploymentTimelineItem(
  item: DeploymentTimelineItem,
): DeploymentTimelinePresentation {
