...
final class Deployment extends Model
{
    ...
    protected $fillable = [
        ...
        'required_resources',
        'custom_fields',
        'deployment_request_decision_valid',
        'priority',
        'status',
        'is_test',
        'location_label',
    ...
    protected function casts(): array
    {
        return [
            ...
            'longitude' => 'decimal:7',
            'custom_fields' => 'array',
            'deployment_request_decision_valid' => 'boolean',
            'drone_flight_context' => 'array',
            'is_test' => 'boolean',
            'province_resolved_at' => 'immutable_datetime',
            'country_resolved_at' => 'immutable_datetime',
    ...
    {
        return $this->belongsToMany(Team::class, 'deployment_team')->withPivot('created_at');
    }

    public function statusHistory(): HasMany
    {
        return $this->hasMany(DeploymentStatusHistory::class);
    }
