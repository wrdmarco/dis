...
final class AdminController extends Controller
{
    ...
    private function validateSettingValue(string $key, mixed $value): mixed
    {
        return match ($key) {
            ...
            'push.template.additional_info_title' => $this->validateStringSetting($key, $value, 160),
            ...
            'push.template.additional_info_body' => $this->validateStringSetting($key, $value, 2000),
            ...
            'devices.heartbeat_interval_minutes' => $this->validateIntegerSetting($key, $value, 15, 60),
