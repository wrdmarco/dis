...
final class StoreWallboardRequest extends FormRequest
{
    ...
    {
        return [
            'configuration' => ['sometimes', 'array:theme,refresh_seconds,rotation_enabled,page_fade_enabled,page_transition,page_transition_duration_ms,page_flip_direction,pages,focus,incident_override,ticker,map'],
