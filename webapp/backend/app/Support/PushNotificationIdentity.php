...
{
    /**
     * All operational phases for one deployment and device share one distributed
    ...
    public static function deliveryOrderLockKey(
        ...
        $scopeId = is_string($deploymentId) && Str::isUlid($deploymentId)
            ? $deploymentId
            : $dispatchRequestId;
     ...
     *
     * The queue job serializes provider submission per deployment and device, so
