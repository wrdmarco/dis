...
final class DeploymentTimelineVisibility
{
    ...
    /**
     * Audit actions that describe an deployment- or dispatch-wide event.
     *
     * @var list<string>
     */
    private const EVERYONE_AUDIT_ACTIONS = [
        'deployments.updated',
        'deployments.deleted',
        'deployments.preannouncement_sent',
        'deployments.active_cancelled_notification_sent',
        'dispatch.sent',
        'dispatch.escalated',
        'dispatch.realerted',
        'location.sharing_stopped_for_deployment',
    ];
    ...
    private const USER_AUDIT_ACTIONS = [
        ...
        'pilot_deployment_report.prepared',
        'pilot_deployment_report.opened_by_admin',
        'pilot_deployment_report.submitted',
        'pilot_deployment_report.submitted_by_admin',
        'pilot_deployment_report.finalized',
        'pilot_deployment_report.finalized_by_admin',
    ];
