...
Route::middleware(['auth:sanctum', 'operational', 'audit.privileged'])->group(function (): void {
    ...
    Route::get('/users/{user}/vacations', [VacationController::class, 'userVacations'])->middleware('permission.any:users.view,status.view');
    Route::post('/users/{user}/vacations', [VacationController::class, 'storeForUser'])->middleware('permission.any:users.manage,status.override');
