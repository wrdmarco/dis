...
final class RoleAndPermissionSeeder extends Seeder
{
    ...
    private array $permissions = [
        ...
        'settings.manage' => ['display_name' => 'Systeeminstellingen beheren', 'category' => 'system_configuration', 'description' => 'Wijzig technische systeem-, integratie-, mail- en beveiligingsinstellingen. Formulieren en branding hebben afzonderlijke rechten.'],
        ...
        'operational-weather.view' => ['display_name' => 'Operationeel weer bekijken', 'category' => 'weather_configuration', 'description' => 'Bekijk de operationele weersverwachting en bijbehorende live radar- en bliksembeelden.'],
