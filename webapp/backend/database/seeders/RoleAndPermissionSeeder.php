...
final class RoleAndPermissionSeeder extends Seeder
{
    ...
    private array $permissions = [
        ...
        'speech.cache.view' => ['display_name' => 'Blijvende spraakvoorbereidingen bekijken', 'category' => 'system_configuration', 'description' => 'Bekijk blijvend voorbereide woonplaatsen, provincies, postcodes en vaste spraakzinnen.'],
        'speech.cache.manage' => ['display_name' => 'Blijvende spraakvoorbereidingen beheren', 'category' => 'system_configuration', 'description' => 'Voeg blijvende spraakvoorbereidingen toe, verwijder ze en leeg de voorbereidingsbibliotheek.'],
